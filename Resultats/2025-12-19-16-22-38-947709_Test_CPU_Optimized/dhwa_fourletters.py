...
# Paths
ROOT = "/home/hbahand/Téléchargements/DHWA-main"
...
# On garde BATCH=8 car c'est ce qui nous donnait les meilleurs résultats (stabilité)
BATCH = 8 
EPOCHS = 1000
PATIENCE = 5
...
if SUBJECTS == 0 :
    ...
    print(f"Subjects selected ({len(subjects)}) : " f"{', '.join(subject.split('-')[0] for subject in subjects)}\n", flush=True)
